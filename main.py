...
if __name__ == "__main__":
    ...
    #  Active sampling  #
    #####################
    parser.add_argument('--active_sampling', help='apply active sampling', action='store_true')
    parser.add_argument('--sampling_fraction', help='fraction of sampled clients used for active sampling', type=float, default=0.3)
    parser.add_argument('--sampling_type', help='type of loss selecttion used, `max or stoch`', type=str, default='max')
    parser.add_argument('--temp', help='boltzmann temperature', type=float, default=0.5)
